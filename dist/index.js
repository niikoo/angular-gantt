import { ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, Injectable, Input, NgModule, Output, Pipe, ViewChild } from '@angular/core';
...
var GanttComponent = (function () {
    function GanttComponent(ganttService, changeDetector) {
        ...
        this.projectUpdates = new EventEmitter();
        this.onGridRowClick = new EventEmitter();
...
export { GanttModule, GanttComponent, GroupByPipe, GanttService, Zooming };
